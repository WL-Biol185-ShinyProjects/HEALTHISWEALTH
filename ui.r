...
tabPanel("References",
         mainPanel(width = "12",
                   div(class = "tx-page",
                       ...
                       p(class = "tx-page-intro",
                         "The following sources were used in the development of this application,
         including clinical literature, public health resources, and data repositories."
                       ),
                       ...
                       div(class = "tx-card",
                           ...
                           div(class = "tx-card-body",
                               tags$ol(
                                 tags$li(style = "margin-bottom: 12px; font-size: 0.93rem; color: #444; line-height: 1.75;",
                                         "\"Genetic Basis of Polycystic Ovary Syndrome (PCOS): Current Perspectives.\"",
                                         tags$em(" PubMed Central (PMC), U.S. National Library of Medicine. "),
                                         tags$a(href = "https://pmc.ncbi.nlm.nih.gov/articles/PMC7959048/",
                                                target = "_blank", "https://pmc.ncbi.nlm.nih.gov/articles/PMC7959048/",
                                                style = "color: #e63985;")
                                 ),
                                 tags$li(style = "margin-bottom: 12px; font-size: 0.93rem; color: #444; line-height: 1.75;",
                                         "\"Article.\"",
                                         tags$em(" PubMed Central (PMC), U.S. National Library of Medicine. "),
                                         tags$a(href = "https://pmc.ncbi.nlm.nih.gov/articles/PMC12221545/",
                                                target = "_blank", "https://pmc.ncbi.nlm.nih.gov/articles/PMC12221545/",
                                                style = "color: #e63985;")
                                 ),
                                 tags$li(style = "margin-bottom: 12px; font-size: 0.93rem; color: #444; line-height: 1.75;",
                                 ...
                                 tags$li(style = "margin-bottom: 12px; font-size: 0.93rem; color: #444; line-height: 1.75;",
                                         "\"Polycystic Ovary Syndrome, Metabolic Syndrome, and Inflammation in the Hispanic Community
                   Health Study/Study of Latinos.\"",
                                         tags$em(" PubMed Central (PMC), U.S. National Library of Medicine.")
                                 ),
                                 tags$li(style = "margin-bottom: 12px; font-size: 0.93rem; color: #444; line-height: 1.75;",
                                         "\"Risk for Premenstrual Dysphoric Disorder is Associated with Genetic Variation in ESR1,
                       ...
                       div(class = "tx-card",
                           ...
                           div(class = "tx-card-body",
                               tags$ol(start = "7",
                                       tags$li(style = "margin-bottom: 12px; font-size: 0.93rem; color: #444; line-height: 1.75;",
                                               "\"Fact Sheets.\"",
                                               tags$em(" Office on Women's Health, U.S. Department of Health & Human Services. "),
                                               tags$a(href = "https://womenshealth.gov/patient-materials/resource/fact-sheets",
                                                      target = "_blank", "https://womenshealth.gov/patient-materials/resource/fact-sheets",
                                                      style = "color: #e63985;")
                                       ),
                                       tags$li(style = "margin-bottom: 12px; font-size: 0.93rem; color: #444; line-height: 1.75;",
                                               "\"What Is PCOS?\"",
                                               tags$em(" WebMD. "),
                                               tags$a(href = "https://www.webmd.com/women/what-is-pcos",
                                                      target = "_blank", "https://www.webmd.com/women/what-is-pcos",
                                                      style = "color: #e63985;")
                                       ),
                                       tags$li(style = "margin-bottom: 12px; font-size: 0.93rem; color: #444; line-height: 1.75;",
                                               "\"What Is PCOS and Can It Be Cured?\"",
                                               tags$em(" OSF HealthCare. "),
                                               tags$a(href = "https://www.osfhealthcare.org/blog/what-is-pcos-and-can-it-be-cured",
                                                      target = "_blank", "https://www.osfhealthcare.org/blog/what-is-pcos-and-can-it-be-cured",
                                                      style = "color: #e63985;")
                                       ),
                                       tags$li(style = "margin-bottom: 12px; font-size: 0.93rem; color: #444; line-height: 1.75;",
                                               "\"Premenstrual Dysphoric Disorder (PMDD).\"",
                                               tags$em(" Mayo Clinic. "),
                                               tags$a(href = "https://www.mayoclinic.org/diseases-conditions/premenstrual-syndrome/expert-answers/pmdd/faq-20058315",
                                                      target = "_blank", "https://www.mayoclinic.org/diseases-conditions/premenstrual-syndrome/expert-answers/pmdd/faq-20058315",
                                                      style = "color: #e63985;")
                                       ),
                                       tags$li(style = "margin-bottom: 12px; font-size: 0.93rem; color: #444; line-height: 1.75;",
                                               "\"PCOS: What Is It and Can It Affect Fertility?\"",
                                               tags$em(" MyOvary. "),
                                               tags$a(href = "https://www.myovry.ca/blogs/health-science/pcos-what-is-it-and-can-it-affect-fertility",
                                                      target = "_blank", "https://www.myovry.ca/blogs/health-science/pcos-what-is-it-and-can-it-affect-fertility",
                                                      style = "color: #e63985;")
                                       )
                               )
                           )
                           ...
                           div(class = "tx-card-body",
                               tags$ol(start = "12",
                                       tags$li(style = "margin-bottom: 12px; font-size: 0.93rem; color: #444; line-height: 1.75;",
                                               ...
                                               tags$em(" Nutrition Care of Rochester. "),
                                               tags$a(href = "https://www.nutritioncareofrochester.com/articles/30-interesting-facts-about-pcos",
                                                      target = "_blank", "https://www.nutritioncareofrochester.com/articles/30-interesting-facts-about-pcos",
                                                      style = "color: #e63985;")
                                       ),
                                       tags$li(style = "margin-bottom: 12px; font-size: 0.93rem; color: #444; line-height: 1.75;",
                                               "\"4 Types of PCOS and How to Know Which One You Have.\"",
                                               tags$em(" Emily Jensen Nutrition. "),
                                               tags$a(href = "https://www.emilyjensennutrition.com/blog/4-types-of-pcos-and-how-to-know-which-one-you-have",
                                                      target = "_blank", "https://www.emilyjensennutrition.com/blog/4-types-of-pcos-and-how-to-know-which-one-you-have",
                                                      style = "color: #e63985;")
                                       ),
                                       tags$li(style = "margin-bottom: 12px; font-size: 0.93rem; color: #444; line-height: 1.75;",
                                               "\"The Four Types of PCOS and Their Symptoms.\"",
                                               tags$em(" Rosa Gynecology. "),
                                               tags$a(href = "https://rosagynecology.com/the-four-types-of-pcos-and-their-symptoms/",
                                                      target = "_blank", "https://rosagynecology.com/the-four-types-of-pcos-and-their-symptoms/",
                                                      style = "color: #e63985;")
                                       ),
                                       tags$li(style = "margin-bottom: 12px; font-size: 0.93rem; color: #444; line-height: 1.75;",
                                               "\"PCOS Prediction Dataset (Top 75 Countries).\"",
                                               tags$em(" Kaggle. "),
                                               tags$a(href = "https://www.kaggle.com/datasets/ankushpanday1/pcos-prediction-datasettop-75-countries",
                                                      target = "_blank", "https://www.kaggle.com/datasets/ankushpanday1/pcos-prediction-datasettop-75-countries",
                                                      style = "color: #e63985;")
                                       )
                               ),
                               div(class = "tx-note",
                                   tags$strong("Note: "), "All references were accessed during the development of this application.
                  URLs were correct at time of access. Some links may require institutional access."
                               )
                           )
                       )
                   )
