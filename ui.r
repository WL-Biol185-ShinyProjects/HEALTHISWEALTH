...
<<<<<<< HEAD
      ...
      "))
                    ...
                    div(class = "about-section",
                        ...
                        div(id = "globalMaps", class = "about-section",
                            ...
                            div(class = "map-card",
                                leafletOutput("pcosMap1990", height = "650px")
                            ),
                            p(class = "map-source",
                              style = "font-size: 1.5rem; color: #e36895",
                              tags$strong("Source: "),
                              tags$a(
                                href = "https://pmc.ncbi.nlm.nih.gov/articles/PMC6266413/",
                                target = "_blank",
                        ...
                        div(class = "about-section",
                            ...
                            div(class = "map-card",
                                leafletOutput("pcosMap", height = "650px")
                            ),
                            p(class = "map-source",
                              style = "font-size: 1.5rem; color: #e36895",
                              tags$strong("Source: "),
                                    ...
                                    tabPanel("Baseline Incidence vs AAPC",
                                             mainPanel(width = 12,
                                                       ...
                                                       div(class = "map-card",
                                                           ...
                                                           div(
                                                             style = "font-size: 1.5rem; font-weight: 700; letter-spacing: 0.15em; text-transform: uppercase; color: #e63985; margin-bottom: 8px;",
                                                             "Analysis"
                                                           ),
                                                           div(
                                                             style = "font-family: 'Playfair Display', serif; font-size: 4.0rem; font-weight: 700; color: #1a1a2e; margin-bottom: 20px; padding-bottom: 12px; border-bottom: 2px solid #fce8f1;",
                                                           ...
                                                           div(
                                                             ...
                                                             div(style = "font-size: 3.0rem; font-weight: 700; color: #1a1a2e; margin-bottom: 10px;",
                                                             ...
                                                             tags$ul(
                                                               ...
                                                               tags$li(style = "font-size: 2.0rem; color: #444; line-height: 1.85; margin-bottom: 6px;",
                                                                       "The ", tags$strong("negative correlation (rho = -0.228)"),
                                                       ...
                                                       ) # end analysis map-card
                                             ) # end mainPanel
                                    ), # end tabPanel Baseline Incidence vs AAPC
                                             ...
                                             div(class = "tx-page",
                                                 ...
                                                 div(class = "tx-card",
                                                     ...
                                                     div(class = "tx-card-body",
                                                         ...
                                                         p(class = "tx-desc",
                                                           "Insulin resistant PCOS occurs when the body's cells don't respond properly to insulin, leading to elevated insulin levels. High insulin then signals the ovaries to overproduce androgens, disrupting ovulation and causing the hallmark symptoms of PCOS. This type is closely tied to diet, lifestyle, and metabolic health."
                                                         ),
                                                         ...
                                                         div(class = "tx-note",
                                                             tags$strong("Key marker: "), "Elevated fasting insulin is the hallmark diagnostic indicator. Also check HbA1c, triglycerides, and ALT. A low-GI diet combined with consistent movement can significantly reverse symptoms in this type."
                                                         )
                                                     )
                                                 )
                                             )
                                   ) # end mainPanel
                          ), # end tabPanel Insulin Resistant PCOS
                                             ...
                                             div(class = "tx-page",
                                                 ...
                                                 div(class = "tx-card",
                                                     ...
                                                     div(class = "tx-card-body",
                                                         ...
                                                         p(class = "tx-desc",
                                                           "Post-pill PCOS develops when the body's hormones take time to rebalance after stopping hormonal contraceptives. The pill suppresses LH and androgens; once discontinued, a temporary rebound surge can create PCOS-like symptoms. This is not permanent PCOS and typically resolves within 3-6 months as the body recalibrates."
                                                         ),
                                                         p(tags$strong("Key symptoms:"), style = "font-size:0.92rem;color:#333;margin-bottom:8px;"),
                                                         div(class = "tx-pills",
                                                         ...
                                                         div(class = "tx-note",
                                                             tags$strong("Important: "), "This is not permanent PCOS. Many women are incorrectly diagnosed after stopping the pill - reassessment after 6 months is recommended before confirming a PCOS diagnosis. Also check: LH, FSH, and androgens."
                                                         )
                                                     )
                                                 )
                                             )
                                   ) # end mainPanel
                          ), # end tabPanel Post-pill PCOS
                                             ...
                                             div(class = "tx-page",
                                                 ...
                                                 div(class = "tx-card",
                                                     ...
                                                     div(class = "tx-card-body",
                                                         ...
                                                         p(class = "tx-desc",
                                                           "Adrenal PCOS is rooted in a dysregulated stress response. When the body is under chronic stress, the adrenal glands produce excess DHEA-S, an androgen that disrupts the hormonal balance needed for regular ovulation. Unlike insulin-resistant PCOS, blood sugar and insulin levels are typically normal in this type, making accurate diagnosis especially important."
                                                         ),
                                                         p(tags$strong("Key symptoms:"), style = "font-size:0.92rem;color:#333;margin-bottom:8px;"),
                                                         div(class = "tx-pills",
                                                         ...
                                                         div(class = "tx-note",
                                                             tags$strong("Key marker: "), "Elevated DHEA-S with normal insulin levels points to adrenal PCOS. Also check cortisol levels. Addressing the root cause chronic stress and HPA axis dysregulation is central to recovery."
                                                         )
                                                     )
                                                 )
                                             )
                                   ) # end mainPanel
                          ), # end tabPanel Adrenal PCOS
                                             ...
                                             div(class = "tx-page",
                                                 ...
                                                 div(class = "tx-card",
                                                     ...
                                                     div(class = "tx-card-body",
                                                         ...
                                                         p(class = "tx-desc",
                                                           "Inflammatory PCOS is driven by the immune system rather than hormonal contraceptives or insulin. Persistent low-grade inflammation, triggered by gut issues, food sensitivities, or environmental toxins, stimulates androgen production and impairs ovulation. Testing for inflammatory markers is key to identifying and managing this type effectively."
                                                         ),
                                                         p(tags$strong("Key symptoms:"), style = "font-size:0.92rem;color:#333;margin-bottom:8px;"),
                                                         div(class = "tx-pills",
                                                         ...
                                                         div(class = "tx-note",
                                                             tags$strong("Note: "), "Inflammatory markers like CRP, white blood cell count, and homocysteine should be tested. Also check vitamin D and ferritin. Eliminating inflammatory triggers: gluten, dairy, or processed foods, may significantly reduce symptoms."
                                                         )
                                                     )
                                                 )
                                             )
                                   ) # end mainPanel
                          ) # end tabPanel Inflammatory PCOS
                          
                        ) # end tabsetPanel pcos_type_tabs
                    ) # end types-tabs-wrap
                    
           ), # end tabPanel Types of PCOS
        ...
        .tx-badge {
          ...
          color: #e63985; border: 1.5px solid #f0a0c8;
        }
        .tx-chevron {
          font-size: 1.4rem; color: #e63985;
      ...
      "))
        ...
        .dc-form-card select {
          ...
          color: #333; width: 100%; margin-bottom: 14px;
        ...
        .dc-divider { border: none; border-top: 1px solid #fce8f1; margin: 18px 0; }
        .dc-submit-btn {
        ...
        .dc-result-card {
          ...
          border-top: 5px solid #e63985; padding: 26px 30px;
        }
        .dc-result-label {
        ...
        .dc-result-title {
          font-family: 'Playfair Display', serif;
          font-size: 2.5rem; font-weight: 700; color: #1a1a2e; margin-bottom: 14px;
        }
        ...
        .dc-note {
          ...
          padding: 14px 18px; font-size: 2.5rem; color: #555; line-height: 1.75;
        }
        ...
        .dc-warning {
          ...
          padding: 14px 18px; font-size: 2.5rem; color: #555; line-height: 1.75; margin-top: 16px;
        }
...
<<<<<<< HEAD
           ...
           ), # end tabPanel Data Check Out
           
           
           # ── 6. RISKS AND COMORBIDITIES (navbarMenu) ───────────────────────────────
          ...
          .map-card {
            background: #ffffff; border-radius: 20px;
            box-shadow: 0 12px 40px rgba(230,57,133,0.10), 0 2px 10px rgba(0,0,0,0.05);
            overflow: hidden; border-top: 5px solid #e63985; padding: 8px;
          }
        ...
        "))
                               ...
                               div(class = "map-page",
                                   div(class = "map-label", "Epidemiology"),
                                   div(class = "map-heading",
                                       "US Uterine Corpus Cancer ", tags$span("Incidence by State")
                                   ),
                                   p(class = "map-intro",
                               ...
                               div(class = "map-page",
                                   div(class = "map-label", "Epidemiology"),
                                   div(class = "map-heading",
                                       "US Uterine Corpus Cancer ", tags$span("Mortality Rate by State")
                                   ),
                                   p(class = "map-intro",
                                     "This map shows state-level uterine corpus cancer mortality rates per 100,000 women. Hover over any state to view its mortality rate."
                                   ),
                                   div(class = "map-card",
                               ...
                               div(class = "map-page",
                                   div(class = "map-label", "Epidemiology"),
                                   div(class = "map-heading",
                                       "US Uterine Corpus Cancer ", tags$span("Death Estimates by State")
                                   ),
                                   p(class = "map-intro",
                                     "This map shows state-level uterine corpus cancer death estimates. Hover over any state to view its values."
                                   ),
                                   div(class = "map-card",
                               ...
                               div(class = "map-page",
                                   div(class = "map-label", "Epidemiology"),
                                   div(class = "map-heading",
                                       "US Uterine Corpus Cancer ", tags$span("New Cases by State")
                                   ),
                                   p(class = "map-intro",
                      ...
                      ) # end tabPanel Endometrial Cancer
        ...
        .team-hero {
          width: 100%; margin-bottom: 60px; padding: 80px 20px 60px;
          text-align: center; background: #FADADD;
          border-radius: 24px; box-shadow: 0 12px 40px rgba(0,0,0,0.06);
        }
        .member-card {
          background: #ffffff; border-radius: 24px; padding: 48px 52px;
          box-shadow: 0 20px 60px rgba(230,57,133,0.12), 0 4px 16px rgba(0,0,0,0.06);
          border-top: 6px solid #e63985; margin-bottom: 48px;
      ...
      "))
                    ...
                    div(class = "team-section",
                        ...
                        div(class = "member-card",
                            tags$img(src = "zanita.png", class = "member-photo", alt = "Member 1"),
                            div(class = "member-info",
                                ...
                                div(class = "member-answer",
                                    "As someone who has been diagnosed with PCOS herself, this project was particularly meaningful to me. PCOS is hard to diagnose, it's even harder when there's essentially no information about it. I am glad our project can shed light on the disease and hopefully help people understand better."
                                )
                            )
                        ),
                        ...
                        # Member 2
                        div(class = "member-card",
                            tags$img(src = "martha.png", class = "member-photo", alt = "Member 2"),
                            div(class = "member-info",
                        ...
                        # Member 3
                        div(class = "member-card",
                            tags$img(src = "fatma.png", class = "member-photo", alt = "Member 3"),
                            div(class = "member-info",
                                ...
                                div(class = "member-question", "What do you like most about this project?"),
                                div(class = "member-answer",
                                    "Women's health has always been at the center of my research interests. Hormonal disorders are both widespread and significantly underdiagnosed, often leaving many individuals without the care and treatment they need. My efforts to spread awareness about Polycystic Ovary Syndrome (PCOS) have not only deepened my understanding of the condition but also highlighted the gaps in knowledge, diagnosis, and treatment that persist in this field."
                                )
                            )
                        )
                    ...
                    div(class = "team-section",
                        ...
                        div(class = "member-card",
                            ...
                            div(class = "member-info",
                                ...
                                tags$hr(class = "member-divider"),
                                div(class = "member-question", "What do you like most about this project?"),
                                div(class = "member-answer", "I am excited about our project in Polycystic Ovary Syndrome (PCOS) because I believe there is a significant lack of awareness and understanding surrounding this condition. Women's health has historically been underrepresented and overlooked in both research and public conversation.")
                            )
                        ),
                        div(class = "member-card",
...
<<<<<<< HEAD
                                  ...
                                  div(class = "tx-card",
                                      div(class = "tx-card-header",
                                          div(class = "tx-toggle-left",
                                              div(class = "tx-icon tx-icon-green", "\U0001F517"),
                                              div(
