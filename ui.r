  ...
  div(class = "tx-card",
      ...
      div(class = "tx-card-body",
          div(class = "tx-badge-row",
              span(class = "tx-badge badge-first-line", "First-choice treatment")
          ),
          p(class = "tx-desc",
            "Combined oral contraceptive pills (OCPs) are considered the first-choice treatment for PCOS.
           They work by suppressing LH and FSH, reducing ovarian androgen production, and regulating
           the menstrual cycle. OCPs also increase sex hormone-binding globulin (SHBG), which further
           lowers free androgen levels — helping to manage symptoms like acne, hirsutism, and
           irregular periods."
          ),
          ...
          div(class = "tx-note",
              tags$strong("Note: "),
              "OCPs do not treat the underlying metabolic causes of PCOS such as insulin resistance.
             They are most effective for symptom management and cycle regulation, and are often used
