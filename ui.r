             ...
             tabPanel("Inflammatory PCOS",
                      fluidPage(
                        div(class = "pcos-page",
                            ...
                            p(class = "pcos-page-intro",
                              "Chronic low-grade inflammation disrupts ovulation and stimulates the adrenal glands to produce
           androgens. This type is often associated with gut dysbiosis, environmental toxins, and immune
